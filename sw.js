/* Service Worker de Presupuestos
   Estrategia:
   - Navegación (HTML): network-first → siempre trae la última versión si hay
     internet; si no hay, usa la copia en caché (funciona offline).
